...
Name (PICN, Package () {
	/* D31: cAVS, SMBus, GbE, Nothpeak */
	Package () { 0x001FFFFF, 0, \_SB.LNKA, 0 },
	Package () { 0x001FFFFF, 1, \_SB.LNKB, 0 },
	Package () { 0x001FFFFF, 2, \_SB.LNKC, 0 },
	Package () { 0x001FFFFF, 3, \_SB.LNKD, 0 },
	/* D29: PCI Express Port 9-16 */
	Package () { 0x001DFFFF, 0, \_SB.LNKA, 0 },
	Package () { 0x001DFFFF, 1, \_SB.LNKB, 0 },
	Package () { 0x001DFFFF, 2, \_SB.LNKC, 0 },
	Package () { 0x001DFFFF, 3, \_SB.LNKD, 0 },
	/* D28: PCI Express Port 1-8 */
	Package () { 0x001CFFFF, 0, \_SB.LNKA, 0 },
	Package () { 0x001CFFFF, 1, \_SB.LNKB, 0 },
	Package () { 0x001CFFFF, 2, \_SB.LNKC, 0 },
	Package () { 0x001CFFFF, 3, \_SB.LNKD, 0 },
	/* D27: PCI Express Port 17-20 */
	Package () { 0x001BFFFF, 0, \_SB.LNKA, 0 },
	Package () { 0x001BFFFF, 1, \_SB.LNKB, 0 },
	Package () { 0x001BFFFF, 2, \_SB.LNKC, 0 },
	Package () { 0x001BFFFF, 3, \_SB.LNKD, 0 },
	/* D23 */
	Package () { 0x0017FFFF, 0, \_SB.LNKA, 0 },
	/* D22: CSME (HECI, IDE-R, KT redirection */
	Package () { 0x0016FFFF, 0, \_SB.LNKA, 0 },
	Package () { 0x0016FFFF, 1, \_SB.LNKB, 0 },
	Package () { 0x0016FFFF, 2, \_SB.LNKC, 0 },
	Package () { 0x0016FFFF, 3, \_SB.LNKD, 0 },
	/* D20: xHCI, OTG, Thermal, Camera */
	Package () { 0x0014FFFF, 0, \_SB.LNKA, 0 },
	Package () { 0x0014FFFF, 1, \_SB.LNKB, 0 },
	Package () { 0x0014FFFF, 2, \_SB.LNKC, 0 },
	Package () { 0x0014FFFF, 3, \_SB.LNKD, 0 },
	/* P.E.G. Root Port D1F0 */
	...
	/* SA IGFX Device */
	Package () { 0x0002FFFF, 0, \_SB.LNKA, 0 },
	/* SA Thermal Device */
	Package () { 0x0004FFFF, 0, \_SB.LNKA, 0 },
	/* SA Skycam Device */
	Package () { 0x0005FFFF, 0, \_SB.LNKA, 0 },
	/* SA GMM Device */
