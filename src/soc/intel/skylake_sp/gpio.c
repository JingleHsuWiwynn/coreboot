...
static const struct pad_group skx_community_nc_groups[] = {
...
static const struct pad_group skx_community_sc_dfx_groups[] = {
	INTEL_GPP(SOUTH_DFX_DFX_PORT_CLK0, SOUTH_DFX_DFX_PORT_CLK0, SOUTH_DFX_DFX_PORT15),
};

static const struct pad_group skx_community_sc0_groups[] = {
...
static const struct pad_group skx_community_sc1_groups[] = {
...
static const struct pad_community skx_gpio_communities[] = {
	{
		.port = PID_GPIOCOM1,
		...
		.groups = skx_community_sc1_groups,
		.num_groups = ARRAY_SIZE(skx_community_sc1_groups),
	}, {
		.port = PID_GPIOCOM1,
		...
		.reset_map = rst_map,
		.num_reset_vals = ARRAY_SIZE(rst_map),
		.groups = skx_community_sc0_groups,
		.num_groups = ARRAY_SIZE(skx_community_sc0_groups),
	}, {
		.port = PID_GPIOCOM1,
		...
		.reset_map = rst_map,
		.num_reset_vals = ARRAY_SIZE(rst_map),
		.groups = skx_community_sc_dfx_groups,
		.num_groups = ARRAY_SIZE(skx_community_sc_dfx_groups),
	}, {
		.port = PID_GPIOCOM0,
		...
		.reset_map = rst_map,
		.num_reset_vals = ARRAY_SIZE(rst_map),
		.groups = skx_community_nc_groups,
		.num_groups = ARRAY_SIZE(skx_community_nc_groups),
	}
};

const struct pad_community *soc_gpio_get_community(size_t *num_communities)
{
	*num_communities = ARRAY_SIZE(skx_gpio_communities);
	return skx_gpio_communities;
}
